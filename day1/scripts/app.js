...
import{LoadHeader, updateActiveNewLink } from "./header";

const routes = {
    "/": "view/pages/home.html",
    "/about": "view/pages/about.html",
    "/products": "view/pages/products.html",
    "/services": "view/pages/services.html",
    "/contact": "view/pages/contact.html",
    "/contact-list": "view/pages/contact-list.html",
    "/edit": "view/pages/edit.html",
    "/login": "view/pages/login.html",
    "/register": "view/pages/register.html",
    "/404": "view/pages/404.html"
};
...
(function () {
    ...
    function handleLogout(event){
        ...
        console.log("logout and Updating the UI thing");
    ...
    function DisplayLoginPage () {
        ...
        if (!loginButton) {
            console.error("Unable to login button not found")
            return;
        }
